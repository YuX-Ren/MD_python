...
trajectory_writer = DCD.DCDWriter("trajectory_lj_c.dcd", u.atoms.n_atoms)
...
for step in range(n_steps):
    positions, velocities, forces, cur_forces = integrate_Beeman(positions, velocities, masses, forces, cur_forces, dt, Energy_Protein)
